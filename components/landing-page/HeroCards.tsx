...
export const HeroCards = () => {
  return (
    <div className="relative hidden h-[500px] w-[700px] flex-row flex-wrap gap-8 lg:flex">
      ...
      {/* Team */}
      <Card className="absolute right-[80px] top-4 flex w-64 flex-col items-center justify-center shadow-black/10 drop-shadow-xl dark:shadow-white/10">
      ...
      {/* Pricing */}
      <Card className="absolute left-[80px] top-[150px] w-64  shadow-black/10 drop-shadow-xl dark:shadow-white/10">
        <CardHeader>
